...
<div class="w3-bar w3-green">
    ...
    <form class="w3-margin-top" method="post" action="/billboard/admin/add?entity=concert_hall">
        <input class="w3-input w3-margin-left" type="text" name="name" placeholder="Название: "/>
        <input class="w3-input w3-margin-left" type="text" name="address" placeholder="Адрес: "/>
