...
<div class="w3-bar w3-green">
    ...
    <form class="w3-margin-top"  method="post" action="/billboard/admin/update?entity=ticket&id=${ticket.getId()}">
        ...
        <input class="w3-input w3-margin-left" type="text" value="${ticket.getCategory()}" name="category" placeholder="Категория"/> <br/>
        <br><label>Стоимость</label>
        <input class="w3-input w3-margin-left" type="text" value="${ticket.getCost()}" name="cost" placeholder="Стоимость"/> <br/>
        <br><label>Количество</label>
        <input class="w3-input w3-margin-left" type="text" value="${ticket.getAmount()}" name="amount" placeholder="Количество"/>
